      ...
      >
        <v-row no-gutters>
          ...
          >
            ...
            <div class="text-medium-emphasis text-sm my-4 flex gap-4">
              <span>
        ...
        >
          ...
          >
            ...
            <v-list>
              ...
              <v-list-item
                v-if="!reviews.length"
                title="Brak opinii dla tego modelu"
              />
            </v-list>
          </v-card>
        </v-col>
        ...
        >
          ...
          >
            ...
            <v-list density="compact">
              <v-list-item
                title="Moc"
                :subtitle="`${model.powerHp || '-'} KM`"
              />

              <v-list-item
                title="Kaucja"
                :subtitle="`${model.depositAmount || '-'} PLN`"
              />

              <v-list-item
                title="Limit km / dzień"
                :subtitle="`${model.mileageLimitPerDay || '-'} km`"
              />

              <v-list-item
                title="Dopłata za nadmiar km"
                :subtitle="`${model.extraMileageFee || '-'} PLN`"
              />
            </v-list>
