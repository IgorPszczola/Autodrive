  ...
  <v-container class="py-md-12 py-8">
    ...
    >
      ...
      >
        ...
        >
          ...
          <h1 class="font-weight-bold text-3xl mb-4 md:text-4xl">
            Rezerwuj auto szybciej,
            <br>
            jedź pewniej.
          </h1>

          <p class="text-medium-emphasis text-base mb-6">
    ...
    >
      ...
      >
        <v-sheet
          ...
          class="pa-5 h-40"
        >
          <div class="font-weight-bold text-xl mb-2">
            {{ item.title }}
          </div>
    ...
    >
      <v-card-text class="d-flex flex-column flex-md-row align-md-center justify-space-between ga-4 pa-10">
        <div>
          <div class="text-medium-emphasis text-xs mb-1">
            SZYBKI START
          </div>

          <h2 class="text-primary text-2xl mb-6">
