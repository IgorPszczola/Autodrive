...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (carModelRepository.count() == 0) {
            ...
            audiModel.setPricePerDay(new BigDecimal("650.00"));
            audiModel.setDepositAmount(new BigDecimal("4000.00"));
            ...
            mercModel.setPricePerDay(new BigDecimal("220.00"));
            mercModel.setDepositAmount(new BigDecimal("1500.00"));
            ...
            golfModel.setPricePerDay(new BigDecimal("180.00"));
            golfModel.setDepositAmount(new BigDecimal("1000.00"));
            ...
            mustangModel.setPricePerDay(new BigDecimal("400.00"));
            mustangModel.setDepositAmount(new BigDecimal("2500.00"));
            ...
            hyundaiModel.setPricePerDay(new BigDecimal("170.00"));
            hyundaiModel.setDepositAmount(new BigDecimal("1000.00"));
            ...
            rav4Model.setPricePerDay(new BigDecimal("190.00"));
            rav4Model.setDepositAmount(new BigDecimal("1200.00"));
            ...
            volvoModel.setPricePerDay(new BigDecimal("380.00"));
            volvoModel.setDepositAmount(new BigDecimal("2500.00"));
            ...
            fiatModel.setPricePerDay(new BigDecimal("110.00"));
            fiatModel.setDepositAmount(new BigDecimal("800.00"));
            ...
            lexusModel.setPricePerDay(new BigDecimal("450.00"));
            lexusModel.setDepositAmount(new BigDecimal("3000.00"));
            ...
            mazdaModel.setPricePerDay(new BigDecimal("160.00"));
            mazdaModel.setDepositAmount(new BigDecimal("1000.00"));
